...
namespace Data
{
    ...
    {
        public string ConnectionString = "Data Source=10.0.0.40,5833;Initial Catalog=ado_test;User ID=student;Password=1010;Encrypt=True;Trust Server Certificate=True";
